...
keymap('n', '<Leader>fg', notify 'workbench.view.search', { silent = true }) -- search all 

keymap('n', '<tab>', notify 'workbench.action.quickOpenNavigateNextInEditorPicker', { silent = true }) -- search all 
keymap('n', '<leader>ta', notify 'workbench.action.toggleActivityBarVisibility', { silent = true }) --


keymap('t', '<C-k>', v_notify 'workbench.action.navigateUp', { silent = true })

keymap('n', '<C-l>', v_notify 'workbench.action.navigateRight', { silent = true })
keymap('n', '<C-h>', v_notify 'workbench.action.navigateLeft', { silent = true })
keymap('n', '<C-k>', v_notify 'workbench.action.navigateUp', { silent = true })
keymap('n', '<C-j>', v_notify 'workbench.action.navigateDown', { silent = true })


keymap('n', '<leader>e', v_notify 'workbench.view.explorer', { silent = true })
